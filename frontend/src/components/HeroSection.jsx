        ...
        <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <img src="lan.png" className="w-18 h-18" alt="" />
                    <p>Transvibe</p>
                  </Link>
                    ...
                    <div className="flex gap-2">
                        <Link to='/translate' className="hidden md:block px-6 py-2 bg-indigo-500 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>
                ...
                {/* Mobile Menu */}
                <div className={`fixed inset-0  bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    {/* Headline + CTA */}
                    <h1 className="text-2xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link to='/translate' className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-full md:px-9 px-6 h-12 m-1 ring-offset-2 ring-1 ring-indigo-400 flex items-center transition-colors">
                            Get started
